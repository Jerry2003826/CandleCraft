...
<div class="mb-3">
    <a href="<?= $this->Url->build(['controller' => 'Bookings', 'action' => 'index']) ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Family Bookings</a>
</div>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= h($payment->booking?->student?->student_name ?? '-') ?></td>
                    </tr>
                    <tr>
                        <th class="text-muted">Course</th>
                        <td><?= h($payment->booking?->class_entity?->course?->course_name ?? '-') ?></td>
                    </tr>
                    <tr>
