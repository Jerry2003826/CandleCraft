...
<div class="card">
    ...
    <div class="card-body">
        <p class="text-muted mb-3">View learning resources for your children's classes.</p>
        <?php if ($bookings->isEmpty()): ?>
            <div class="text-center py-5 text-muted">
                <i class="bi bi-book" style="font-size: 48px;"></i>
                <p class="mt-3">Your children need to have active bookings to see learning resources.</p>
                <a href="<?= $this->Url->build(['prefix' => 'Parent', 'controller' => 'Courses', 'action' => 'index']) ?>" class="btn btn-sm btn-primary mt-2">Browse Courses</a>
            </div>
        <?php elseif (empty($resources)): ?>
            <div class="text-center py-5 text-muted">
                <i class="bi bi-folder" style="font-size: 48px;"></i>
                <p class="mt-3">No learning resources have been uploaded for your children's classes yet.</p>
            </div>
        <?php else: ?>
                    ...
                    <div class="card mb-3 border">
                        <div class="card-header bg-light">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <small class="text-muted"><?= h($booking->student?->student_name ?? 'Student') ?> — <?= h($booking->class_entity ? $booking->class_entity->class_code : 'Class') ?></small>
