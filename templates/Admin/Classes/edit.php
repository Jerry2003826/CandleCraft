...
<div class="card">
    <div class="card-header"><h5 class="mb-0">Edit: <?= h($class->class_code) ?></h5></div>
    <div class="card-body">
        <?= $this->Form->create($class) ?>
            <div class="mb-3">
                <label for="class-code" class="form-label">Class Code</label>
                <?= $this->Form->text('class_code', ['id' => 'class-code', 'required' => true, 'maxlength' => 30, 'pattern' => '[A-Za-z0-9-]{3,30}', ]) ?>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 mt-3">
                ...
                <?= $this->Form->text('location', ['id' => 'location', 'required' => true, 'maxlength' => 150, ]) ?>
            </div>
            <div class="row g-3">
                <div class="col-md-6">
                    <label for="capacity" class="form-label">Capacity</label>
                    <?= $this->Form->number('capacity', ['id' => 'capacity', 'min' => 1, 'max' => 200, ]) ?>
                </div>
                <div class="col-md-6">
                    <label for="class-status" class="form-label">Status</label>
                    <?= $this->Form->select('class_status', ['scheduled' => 'Scheduled', 'ongoing' => 'Ongoing', 'completed' => 'Completed', 'cancelled' => 'Cancelled', 'full' => 'Full'], ['id' => 'class-status', ]) ?>
                </div>
            </div>
            <div class="mb-3 mt-3">
