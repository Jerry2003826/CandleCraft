...
<div class="card">
    <div class="card-header"><h5 class="mb-0">Edit: <?= h($student->student_name) ?></h5></div>
    <div class="card-body">
        <?= $this->Form->create($student) ?>
            ...
            <div class="mb-3">
                ...
                <?= $this->Form->select('student_status', ['active' => 'Active', 'inactive' => 'Inactive'], ['id' => 'student-status', ]) ?>
            </div>
            <div class="mb-3">
            ...
            <?= $this->Form->button(__('Update Student'), ['class' => 'btn btn-success']) ?>
