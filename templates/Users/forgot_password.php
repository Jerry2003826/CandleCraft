    ...
    <div class="login-form-container">
        <div class="login-form-wrapper">
            <div class="login-header">
                ...
                <p class="login-subtitle" style="font-size: 1.1rem;">Enter your email and we'll send you a reset link.</p>
            </div>
            ...
            <div class="login-fields">
                ...
                <div class="login-actions">
                    <?= $this->Form->button('Send Reset Link', ['class' => 'login-submit-btn', 'type' => 'submit']) ?>
                </div>
