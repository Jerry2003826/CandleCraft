...
class StripeWebhookEvent extends Entity
{
    protected array $_accessible = [
        ...
        'replay_count' => true,
        'last_replay_event_id' => true,
        'last_replay_payload_hash' => true,
        'last_replay_seen_at' => true,
        'last_suppressed_status_update' => true,
        'last_suppressed_status_event_id' => true,
        'last_suppressed_status_payload_hash' => true,
        'last_suppressed_status_seen_at' => true,
        'first_seen_at' => true,
